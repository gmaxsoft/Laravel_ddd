...
<div class="max-w-md w-full mx-auto">
    <h1 class="text-2xl font-semibold mb-6 text-[#1b1b18] dark:text-[#EDEDEC]">Przypomnienie hasła</h1>
    ...
    <p class="mb-4 text-sm text-[#706f6c] dark:text-[#A1A09A]">
        Podaj adres e-mail powiązany z kontem. Wyślemy Ci link do zresetowania hasła.
    </p>
