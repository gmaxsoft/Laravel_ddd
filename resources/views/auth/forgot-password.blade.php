...
@section('title', 'Przypomnienie hasła')

@section('hero_title', 'Zresetuj hasło')
@section('hero_subtitle', 'Podaj adres e-mail, a wyślemy Ci link do ustawienia nowego hasła.')
...
<div class="space-y-8">
    ...
    <div>
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Przypomnienie hasła</h1>
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Wprowadź e-mail powiązany z kontem</p>
    </div>
